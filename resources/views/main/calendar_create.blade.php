...
@section('content-f')
    <div class="breadcrumb-box">
        Calendar <i class="ml-4 arrow-style fas fa-chevron-right"></i> <i class="arrow-style fas fa-chevron-right mr-4"></i> <a href="{{ url('/calendar/event/new') }}" class="breadcrumb-style">Create new event</a> 
    </div>
@endsection
        ...
        <div class="col-md-12 pl-13 pr-27 content-row">
            ...
            <div class="card card-custom">
                ...
                <div class="card-body card-body-custom">
                    <div class="mt-2"></div>
                    <form action="{{ url('/calendar/event/confirm-creation') }}" method="post" autocomplete="off">
                        @csrf
                        <div class="row">
                            <div class="mt-1"></div>
                            ...
                            <div class="col-md-12 form-group mt-3">
                                ...
                                <div class="mt-2"></div>
                                <input type="text" name="description" class="form-control" placeholder="Christmas" required>
                            </div>
                            <div class="col-md-12 form-group mt-3">
