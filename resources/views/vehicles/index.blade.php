...
<title>{{ __('Garage | Vehicles List') }}</title>
...
@section('toolbar-content')
    ...
    @section('create-button')
        <a href="{{ url('/work/vehicles/create') }}" class="btn btn-sm btn-primary">{{ __('Create') }}</a>
    @endsection
        ...
        <div id="kt_content_container" class="container-xxl pb-6">
            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <!--end::Svg Icon-->
                            <input type="text" id="searchinput" data-kt-user-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="{{ __('Search vehicles') }}" />
                        </div>
                        <!--end::Search-->
                    </div>
                    <!--begin::Card title-->
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <!--end::Export-->
                            <!--begin::Add Order-->
                            <a href="{{ url('/work/vehicles/create') }}" class="btn btn-primary">
                ...
                <div class="card-body py-4">
                    <!--begin::Table-->
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_vehicles">
                        <!--begin::Table head-->
                        <thead>
                            <!--begin::Table row-->
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex flex-column">
                                        <a href="{{ url('/work/vehicles/'.$vehicle->id) }}" class="text-gray-800 text-hover-primary mb-1">{{ $vehicle->model }}</a>
                                    </div>
                                </td>
                                <!--end::Model-->
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        @canany(['equipment.view', 'everything'])
                                            <div class="menu-item px-3">
                                                <a href="{{ url('/work/vehicles/'.$vehicle->id) }}" class="menu-link px-3">{{ __('View') }}</a>
                                            </div>
                                        @endcanany
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        @canany(['equipment.edit', 'everything'])
                                            <div class="menu-item px-3">
                                                <a href="{{ url('/work/vehicles/edit/'.$vehicle->id) }}" class="menu-link px-3">{{ __('Edit') }}</a>
                                            </div>
                                        @endcanany
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        @canany(['equipment.delete', 'everything'])
                                            <div class="menu-item px-3">
                                                <a href="{{ url('/work/vehicles/pre-delete/'.$vehicle->id) }}" class="menu-link px-3" data-kt-users-table-filter="delete_row">{{ __('Delete') }}</a>
                                            </div>
                                        @endcanany
                                        <!--end::Menu item-->
                                    </div>
...
@endsection
    ...
    <script>
        ...
        $(document).ready( function () {
            ...
            var table = $('#kt_table_vehicles').DataTable({
                info: !1,
                "order": [[ 1, "desc" ]],
                colReorder: true,
                stateSave: true,
