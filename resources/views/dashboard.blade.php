...
@section('toolbar-content')
    {{-- <div class="breadcrumb-box">
        User Management <i class="ml-4 arrow-style fas fa-chevron-right"></i> <i class="arrow-style fas fa-chevron-right mr-4"></i> Users <i class="ml-4 arrow-style fas fa-chevron-right"></i> <i class="arrow-style fas fa-chevron-right mr-4"></i> <a href="{{ url('/management/users') }}" class="breadcrumb-style">Users List</a>
    </div> --}}
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="row gy-5 g-xl-8">
                ...
                <div class="col-xl-6">
                    ...
                    <div class="card card-xl-stretch-50 mb-5 mb-xl-5">
                        <!--begin::Body-->
            ...
            <div class="row g-5 g-xl-8">
                ...
                <div class="col-xl-12">
                    ...
                    <div class="card card-xxl-stretch mb-5 mb-xl-8 pb-5">
                        <!--begin::Header-->
                                            ...
                                            <tbody>
                                                    ...
                                                    <td>
                                                        <div class="symbol symbol-45px me-2">
                                                            <span class="symbol-label">
                                                                <img src="{{ url('media/svg/brand-logos/plurk.svg') }}" class="h-50 align-self-center" alt="" />
                                                            </span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="symbol symbol-45px me-2">
                                                            <span class="symbol-label">
                                                                <img src="{{ url('media/svg/brand-logos/telegram.svg') }}" class="h-50 align-self-center" alt="" />
                                                            </span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="symbol symbol-45px me-2">
                                                            <span class="symbol-label">
                                                                <img src="{{ url('media/svg/brand-logos/vimeo.svg') }}" class="h-50 align-self-center" alt="" />
                                                            </span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="symbol symbol-45px me-2">
                                                            <span class="symbol-label">
                                                                <img src="{{ url('media/svg/brand-logos/bebo.svg') }}" class="h-50 align-self-center" alt="" />
                                                            </span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="symbol symbol-45px me-2">
                                                            <span class="symbol-label">
                                                                <img src="{{ url('media/svg/brand-logos/kickstarter.svg') }}" class="h-50 align-self-center" alt="" />
                                                            </span>
                                                        </div>
                                                    </td>
                                                    <td>
