...
<title>{{ __('Garage | Orders List') }}</title>
...
@section('toolbar-content')
    ...
    @section('create-button')
        <div class="mt-3">
            <form action="{{ url('/work/orders/create') }}" method="post">
                @csrf
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <!--end::Export-->
                            <!--begin::Add Order-->
                            <form action="{{ url('/work/orders/create') }}" method="post" style="padding: 0; margin: 0;">
                                @csrf
                                ...
                                <!--end::Svg Icon-->{{ __('New Order') }}</button>
                            </form>
                            <!--end::Add Order-->
                        </div>
                        <!--end::Toolbar-->
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_orders">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="">{{ __('ID') }}</th>
                                <th class="">{{ __('Customer') }}</th>
                                <th class="">{{ __('Vehicle VIN') }}</th>
                                <th class="">{{ __('Vehicle Type') }}</th>
                                <th class="">{{ __('Order Budget') }}</th>
                                <th class="">{{ __('Status') }}</th>
                                <th class="">{{ __('Assigned') }}</th>
                        ...
                        <tbody class="text-gray-600 fw-bold">
                            ...
                            <tr>
                                ...
                                <td>
                                    {{-- <div class="form-check form-check-sm form-check-custom form-check-solid">
                                        ...
                                        <div class="d-flex flex-column">
                                            <a href="{{ url('/work/orders/'.$order->id) }}" class="text-gray-800 text-hover-primary mb-1">{{ $order->id }}</a>
                                        </div>
                                </td>
                                <!--end::ID-->
                                <!--begin::Customer=-->
                                ...
                                @if($order->customer_id)
                                    ...
                                    @php $customer = \App\Models\Customer::find($order->customer_id); @endphp

                                    <td>
                                        <div class="d-flex flex-column">
                                            <a href="{{ url('/management/customers/'.$order->customer_id) }}" class="text-gray-800 text-hover-primary mb-1">{{ $customer->name . " " . $customer->last_name }}</a>
                                        </div>
                                    </td>
                                @else
                                    <td>
                                ...
                                @if($order->vehicle_id)
                                    ...
                                    @foreach($vehicles as $vehicle)
                                        @if($vehicle->id == $order->vehicle_id)
                                            <td>
                                                <div style="text-transform: uppercase;" class="d-flex flex-column">
                                                    {{ $vehicle->type }}
                                                </div>
                                            </td>
                                        @endif
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        <!--begin::Menu item-->
                                        @canany(['orders.view', 'everything'])
                                            <div class="menu-item px-3">
                                                <a href="{{ url('/work/orders/'.$order->id) }}" class="menu-link px-3">{{ __('View') }}</a>
                                            </div>
                                        @endcanany
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        @canany(['orders.edit', 'everything'])
                                            <div class="menu-item px-3">
                                                <a href="{{ url('/work/orders/edit/'.$order->id) }}" class="menu-link px-3">{{ __('Edit') }}</a>
                                            </div>
                                        @endcanany
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        @canany(['orders.delete', 'everything'])
                                            <div class="menu-item px-3">
                                                <a href="{{ url('/work/orders/pre-delete/'.$order->id) }}" class="menu-link px-3" data-kt-users-table-filter="delete_row">{{ __('Delete') }}</a>
                                            </div>
                                        @endcanany
                                        <!--end::Menu item-->
                                    </div>
...
@endsection
    ...
    <script>
        ...
        $(document).ready( function () {
            ...
            var table = $('#kt_table_orders').DataTable({
                info: !1,
                "order": [[ 1, "desc" ]],
                colReorder: true,
                stateSave: true,
