        ...
        <div class="col-md-12 pl-13 pr-27 content-row">
            ...
            <div class="card card-custom">
                ...
                <div class="card-body card-body-custom">
                    <div class="mt-2"></div>
                    <form action="{{ url('/work/parts/confirm-order') }}" method="post" autocomplete="off">
                        @csrf
                        <div class="row">
                            <div class="mt-3"></div>
                        ...
                        <div class="row bought-parts-row">
                            <div class="mt-3"></div>
                            <div class="pre-form-texts">Bought part(-s)</div>
                            <div class="col-md-12 form-group mt-3 mb-3">
                                <div class="mt-2"></div>
                                <label for="">Search for parts that you have bought before</label>
                                <input type="text" class="form-control search-bought-parts" placeholder="&#xF002; Search" style="font-family:Arial, FontAwesome; font-size: 14px;">
                                <div class="mt-2"></div>
                        ...
                        <div class="row initial-parts-row">
                            ...
                            <div class="col-md-2 form-group mt-3">
                                ...
                                <div class="mt-2"></div>
                                <input type="text" name="product_no[]" class="form-control" placeholder="">
                            </div>
                            <div class="col-md-2 form-group mt-3">
                            ...
                            <div class="col-md-2 form-group mt-3">
                                ...
                                <div class="mt-2"></div>
                                <input type="number" onchange="(function(el){el.value=parseFloat(el.value).toFixed(2);})(this)" step="0.01" name="unit_cost[]" class="form-control" placeholder="" required>
                            </div>
                            <div class="col-md-2 form-group mt-3">
                                <label for="">Unit Cost Today</label>
                                <div class="mt-2"></div>
                                <input type="number" onchange="(function(el){el.value=parseFloat(el.value).toFixed(2);})(this)" step="0.01" name="unit_cost_today[]" class="form-control" placeholder="">
                            </div>
                            <div class="col-md-2 form-group mt-3">
                                <label for="">Cost</label>
                                <div class="mt-2"></div>
                                <input type="number" onchange="(function(el){el.value=parseFloat(el.value).toFixed(2);})(this)" step="0.01" name="cost[]" class="form-control" placeholder="">
                            </div>
                            <div class="col-md-2 form-group mt-3">
                                <label for="">Qty Rec.</label>
                                <div class="mt-2"></div>
                                <input type="number" step="1" name="qty_rec[]" class="form-control" placeholder="">
                            </div>
                            <div class="col-md-2 form-group mt-3">
                                <label for="">Qty Rec. Today</label>
                                <div class="mt-2"></div>
                                <input type="number" step="1" name="qty_rec_today[]" class="form-control" placeholder="">
                            </div>
                            <div class="col-md-2 form-group mt-3">
                                <label for="">Date Rec.</label>
                                <div class="mt-2"></div>
                                <input type="text" name="date_rec[]" class="form-control" placeholder="">
                            </div>
                            <div class="col-md-2 form-group mt-3">
                                <label for="">Qty Return</label>
                                <div class="mt-2"></div>
                                <input type="number" step="1" name="qty_return[]" class="form-control" placeholder="">
                            </div>
                            <div class="col-md-2 form-group mt-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mt-3">
                                <label for="">Send email with parts list to</label>
                        ...
                        <div class="mt-3"></div>
                        <button type="button" class="btn btn-primary btn-primary-second col-12" id="add_more_parts"><i class="fas fa-plus-square"></i> Add more part(-s)</button>
                        <div class="mt-3"></div>
                        <div class="row">
                            <div class="col-md-12">
...
<script>
                ...
                success:function(data) {
                    ...
                    <div class="row parts-row">\
                        ...
                        <div class="col-md-2 form-group mt-3">\
                            <label for="">Product No. (Supplier)</label>\
                            <div class="mt-2"></div>\
                            <input type="text" name="product_no[]" class="form-control" placeholder="" value="'+checkForNull(obj['product_no'])+'">\
                        </div>\
                        <div class="col-md-2 form-group mt-3">\
                            <label for="">Order Qty</label>\
                            <div class="mt-2"></div>\
                        ...
                        <div class="col-md-2 form-group mt-3">\
                            <label for="">Unit Cost Today</label>\
                            <div class="mt-2"></div>\
                            <input type="number" onchange="(function(el){el.value=parseFloat(el.value).toFixed(2);})(this)" step="0.01" name="unit_cost_today[]" class="form-control" value="'+checkForNull(obj['unit_cost_today'])+'" placeholder="">\
                        </div>\
                        <div class="col-md-2 form-group mt-3">\
                            <label for="">Cost</label>\
                            <div class="mt-2"></div>\
                            <input type="number" onchange="(function(el){el.value=parseFloat(el.value).toFixed(2);})(this)" step="0.01" name="cost[]" class="form-control" value="'+checkForNull(obj['cost'])+'" placeholder="">\
                        </div>\
                        <div class="col-md-2 form-group mt-3">\
                            <label for="">Qty Rec.</label>\
                            <div class="mt-2"></div>\
                            <input type="number" step="1" name="qty_rec[]" class="form-control" value="'+checkForNull(obj['qty_rec'])+'" placeholder="">\
                        </div>\
                        <div class="col-md-2 form-group mt-3">\
                            <label for="">Qty Rec. Today</label>\
                            <div class="mt-2"></div>\
                            <input type="number" step="1" name="qty_rec_today[]" class="form-control" value="'+checkForNull(obj['qty_rec_today'])+'" placeholder="">\
                        </div>\
                        <div class="col-md-2 form-group mt-3">\
                            <label for="">Date Rec.</label>\
                            <div class="mt-2"></div>\
                            <input type="text" name="date_rec[]" class="form-control" value="'+checkForNull(obj['date_rec'])+'" placeholder="">\
                        </div>\
                        <div class="col-md-2 form-group mt-3">\
                            <label for="">Qty Return</label>\
                            <div class="mt-2"></div>\
                            <input type="number" step="1" name="qty_return[]" class="form-control" value="'+checkForNull(obj['qty_return'])+'" placeholder="">\
                        </div>\
                        <div class="col-md-2 form-group mt-3">\
                            <label for="">Instructions</label>\
                            <div class="mt-2"></div>\
                        ...
                        <div class="col-md-2 form-group mt-3">\
                            <label for="">Model</label>\
                            <div class="mt-2"></div>\
                            <input type="text" name="model[]" class="form-control" value="'+checkForNull(obj['model'])+'" placeholder="">\
                        </div>\
                        <div class="col-md-2 form-group mt-3">\
                            <label for="">Make</label>\
                            <div class="mt-2"></div>\
                            <input type="text" name="make[]" class="form-control" value="'+checkForNull(obj['make'])+'" placeholder="">\
                        </div>\
                        <div class="col-md-2 form-group mt-3">\
                            <label for="">Style</label>\
                            <div class="mt-2"></div>\
                            <input type="text" name="style[]" class="form-control" value="'+checkForNull(obj['style'])+'" placeholder="">\
                        </div>\
                        <div class="col-md-2 form-group mt-3 mb-3">\
                            <label for="">Part Category</label>\
                            <div class="mt-2"></div>\
                            <input type="text" name="category[]" class="form-control" value="'+checkForNull(obj['category'])+'" placeholder="">\
    ...
    $('.search-bought-parts').on('keyup', function(e) {

        var product = $('.search-bought-parts').val();
        var supplier = $('#supplier-select option:selected').val();

        $.ajax({
            type: 'POST',
            url: '/parts/get-similar-product',
