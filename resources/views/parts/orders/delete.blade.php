...
@section('content-d')
    ...
    <div class="row">
        ...
        <div class="col-md-12 pl-13 pr-27 content-row">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form action="{{ url('/work/parts/order/delete/'.$part->order_id) }}" method="post">
            ...
            <div class="row">
                ...
                <div class="col-6 form-group">
                    <a href="{{ url('/work/parts') }}" class="col-12 btn btn-primary"><i class="fas fa-times-circle"></i> No</a>
                </div>
            </div>
