...
<title>{{ __('Garage | Delete Supplier') }} {{ $supplier->supplier_name }}</title>
        ...
        <div id="kt_content_container" class="container-xxl pb-6">
            ...
            <div class="alert alert-dismissible bg-light-danger d-flex flex-column flex-sm-row p-5 mb-10">
                ...
                <div class="d-flex flex-column pe-0 pe-sm-10">
                    ...
                    <!--end::Title-->
                    <!--begin::Content-->
                    {{ __('Are you sure you want to permanently delete this supplier?') }}
                    <!--end::Content-->
                </div>
                <!--end::Wrapper-->
            ...
            <div class="row">
                ...
                <div class="col-6 form-group">
                    <a href="{{ url('/management/suppliers') }}" class="col-12 btn btn-danger"><i class="fas fa-times-circle"></i> {{ __('No') }}</a>
                </div>
            </div>
