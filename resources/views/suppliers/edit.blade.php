...
<title>{{ __('Garage | Edit Supplier') }}</title>
...
@section('toolbar-content')
    ...
    @section('description')
        {{ __('Edit Supplier ') }} {{ $supplier->supplier_name }}
    @endsection
    ...
    @section('create-button')
        <a href="{{ url('/management/suppliers/edit'.$supplier->id) }}" class="btn btn-sm btn-primary">
...
@section('container-content')
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl pb-8">
            ...
            <form id="kt_modal_add_user_form" class="form" action="{{ url('/management/suppliers/edit/confirm/'.$supplier->id) }}" method="post" enctype="multipart/form-data" autocomplete="off">
            {{ method_field('PUT') }}
            <!--begin::Card-->
            <div class="card">
                <!--begin::Card header-->
                ...
                <div class="card-body py-4">
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('/media/svg/avatars/blank.svg')">
                            ...
                            @if($supplier->avatar)
                                <div class="image-input-wrapper w-125px h-125px" style="background-image: url('{{ $supplier->avatar }}');"></div>
                            @else
                    ...
                    <div class="form-group row">
                        ...
                        <div class="fv-row mb-7 col-md-6 col-xs-12">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="supplier_company" value="{{ $supplier->supplier_company }}" class="form-control form-control-sm form-control-solid mb-3 mb-lg-0" placeholder="Express Inc."/>
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="fv-row mb-7 col-md-6 col-xs-12">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="supplier_name" value="{{ $supplier->supplier_name }}" class="form-control form-control-sm form-control-solid mb-3 mb-lg-0" placeholder="John Doe"/>
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="fv-row mb-7 col-md-2 col-xs-12">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="supplier_city" value="{{ $supplier->supplier_city }}" class="form-control form-control-sm form-control-solid mb-3 mb-lg-0" placeholder="New York" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="fv-row mb-7 col-md-4 col-xs-12">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="supplier_address" value="{{ $supplier->supplier_address }}" class="form-control form-control-sm form-control-solid mb-3 mb-lg-0" placeholder="20 Water Street" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="fv-row mb-7 col-md-3 col-xs-12">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="supplier_post" value="{{ $supplier->supplier_post }}" class="form-control form-control-sm form-control-solid mb-3 mb-lg-0" placeholder="NY 10023" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="fv-row mb-7 col-md-3 col-xs-12">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="supplier_state" value="{{ $supplier->supplier_state }}" class="form-control form-control-sm form-control-solid mb-3 mb-lg-0" placeholder="New York" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="fv-row mb-7 col-md-6 col-xs-12">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="email" name="supplier_email" value="{{ $supplier->supplier_email }}" class="form-control form-control-sm form-control-solid mb-3 mb-lg-0" placeholder="smith@domain.com" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="fv-row mb-7 col-md-6 col-xs-12">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="supplier_telephone" value="{{ $supplier->supplier_telephone }}" class="form-control form-control-sm form-control-solid mb-3 mb-lg-0" placeholder="+37062222345" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="fv-row mb-7 col-md-6 col-xs-12">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="supplier_fax" value="{{ $supplier->supplier_fax }}" class="form-control form-control-sm form-control-solid mb-3 mb-lg-0" placeholder="555-123-4567" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="fv-row mb-7 col-md-6 col-xs-12">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="supplier_alt_phone" value="{{ $supplier->supplier_alt_phone }}" class="form-control form-control-sm form-control-solid mb-3 mb-lg-0" placeholder="+37062222346" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                ...
                <div class="card-body py-4">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="fv-row mb-7 col-md-6 col-xs-12">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="billing_company" value="{{ $supplier->billing_company }}" class="form-control form-control-sm form-control-solid mb-3 mb-lg-0" placeholder="Express Inc."/>
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="fv-row mb-7 col-md-6 col-xs-12">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="billing_name" value="{{ $supplier->billing_name }}" class="form-control form-control-sm form-control-solid mb-3 mb-lg-0" placeholder="John Doe"/>
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="fv-row mb-7 col-md-2 col-xs-12">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="billing_city" value="{{ $supplier->billing_city }}" class="form-control form-control-sm form-control-solid mb-3 mb-lg-0" placeholder="New York" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="fv-row mb-7 col-md-4 col-xs-12">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="billing_address" value="{{ $supplier->billing_address }}" class="form-control form-control-sm form-control-solid mb-3 mb-lg-0" placeholder="20 Water Street" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="fv-row mb-7 col-md-3 col-xs-12">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="billing_post" value="{{ $supplier->billing_post }}" class="form-control form-control-sm form-control-solid mb-3 mb-lg-0" placeholder="NY 10023" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="fv-row mb-7 col-md-3 col-xs-12">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="billing_state" value="{{ $supplier->billing_state }}" class="form-control form-control-sm form-control-solid mb-3 mb-lg-0" placeholder="New York" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="fv-row mb-7 col-md-6 col-xs-12">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="email" name="billing_email" value="{{ $supplier->billing_email }}" class="form-control form-control-sm form-control-solid mb-3 mb-lg-0" placeholder="smith@domain.com" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="fv-row mb-7 col-md-6 col-xs-12">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="billing_telephone" value="{{ $supplier->billing_telephone }}" class="form-control form-control-sm form-control-solid mb-3 mb-lg-0" placeholder="+37062222345" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="fv-row mb-7 col-md-6 col-xs-12">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="billing_fax" value="{{ $supplier->billing_fax }}" class="form-control form-control-sm form-control-solid mb-3 mb-lg-0" placeholder="555-123-4567" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="fv-row mb-7 col-md-6 col-xs-12">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="billing_alt_phone" value="{{ $supplier->billing_alt_phone }}" class="form-control form-control-sm form-control-solid mb-3 mb-lg-0" placeholder="+37062222346" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
            ...
            <!--begin::Card-->
            <div class="card mt-8" id="contacts">
                <!--begin::Card header-->
                <div class="card-header border-0">
                    <!--begin::Card title-->
                    <div class="card-title mt-8 mb-4">
                ...
                <!--end::Card header-->
                <!--begin::Card body-->
                <div class="add_more_contacts_rows card-body py-4 m-auto">
                                ...
                                <tbody>
                                    ...
                                    @for($i = 0; $i < $contactsCount; $i++)
                                        <tr id="tableRow{{ $i }}">
                                            ...
                                            <td class="text-end"><button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#contact{{ $i }}">{{ __('Edit') }}</button></td>
                                        </tr>
                                    @endfor
    ...
    <div class="modal fade" id="contact{{ $i }}" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <h5 class="modal-title" id="modalLabel">{{ __('Alt Contact') }} {{ $allContactsNames[$i] }}</h5>
                    <button type="button" class="btn btn-light btn-sm closemodal" data-dismiss="modal" data-toggle='tooltip' title='Close' aria-label="Close">
                        <span aria-hidden="true" style="font-size: 18px;color:black;">&times;</span>
                    </button>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger deleteButton"><i class="fa fa-minus-circle" aria-hidden="true"></i> {{ __('Delete') }}</button>
                    <button type="submit" class="btn btn-success"><i class="fa fa-check-circle" aria-hidden="true"></i> {{ __('Update') }}</button>
                </div>
                </form>
            </div>
        </div>
    ...
    <script>
        ...
        $(document).ready( function () {
            ...
            $('#add_more_contacts').on('click', function() {
                ...
                $('.add_more_contacts_rows').append('<div class="appended_contact mt-8 mb-8"><div><button type="button" style="float:right;" class="btn btn-sm btn-secondary cancel_contact">Remove</button></div>\
                <div class="row">\
