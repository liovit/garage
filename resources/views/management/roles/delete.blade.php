...
<title>{{ __('Garage | Delete Role') }} {{ $role->name }}</title>
        ...
        <div id="kt_content_container" class="container-xxl pb-6">
            ...
            <div class="alert alert-dismissible bg-light-danger d-flex flex-column flex-sm-row p-5 mb-10">
                ...
                <div class="d-flex flex-column pe-0 pe-sm-10">
                    ...
                    <!--end::Title-->
                    <!--begin::Content-->
                    {{ __('Are you sure you want to permanently delete this role?') }}
                    <!--end::Content-->
                </div>
                <!--end::Wrapper-->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <table class="table table-bordered table-striped" style="margin-bottom: 0;">
                                <tr>
                                    <th style="">{{ __('Title') }}</th>
                                    <td field-key='name'>{{ $role->name }}</td>
                                </tr>
                                <tr>
                                    <th>{{ __('Description') }}</th>
                                    <td field-key='email'>{{ $role->description }}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td field-key='role'>
                                        <select class="permissions-select form-control form-control-solid" name="permissions[]" multiple="multiple" disabled>
                                            ...
                                            @if($role->permissions)
                                                ...
                                                @php 
                                                    ...
                                                    foreach($role->permissions as $permission) { array_push($rolePermissionsArray, $permission->id); }
                                                @endphp
            
                                                @foreach($permissions as $permission)
                                                    @foreach($rolePermissionsArray as $rolePermissionId)
            ...
            <div class="row">
                ...
                <div class="col-6 form-group">
                    <a href="{{ url('/management/roles') }}" class="col-12 btn btn-danger"><i class="fas fa-times-circle"></i> No</a>
                </div>
            </div>
