...
<title>{{ __('Garage | Create New Role') }}</title>
...
@section('toolbar-content')
    ...
    @section('create-button')
        <a href="{{ url('/management/roles/create') }}" class="btn btn-sm btn-primary">
        ...
        <div id="kt_content_container" class="container-xxl pb-6">
            ...
            <div class="card">
                ...
                <div class="card-body py-4">
                    ...
                    <form id="kt_modal_add_user_form" class="form" action="{{ url('/management/roles/confirm-creation') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="fv-row mb-7 col-md-12 col-xs-12">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="name" value="{{ old('name') }}" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Moderator"/>
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                        ...
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="required fw-bold fs-6 mb-2">{{ __('Description') }}</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <textarea type="text" name="description" value="{{ old('description') }}" class="form-control form-control-solid mb-3 mb-lg-0"></textarea>
                            <!--end::Input-->
                            <div class="form-text">{{ __('Describe a little of what this role is supposed to do.') }}</div>
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="required fw-bold fs-6 mb-2">{{ __('Permissions') }}</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <select class="permissions-select form-control form-control-solid" name="permissions[]" multiple="multiple">
                        ...
                        <div class="" style="float:right;">
                            <a href="{{ url('/management/roles/create') }}" class="btn btn-light me-3">{{ __('Discard') }}</a>
