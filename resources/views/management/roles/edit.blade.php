...
<title>{{ __('Garage | Edit Role ') }} {{ $role->name }}</title>
        ...
        <div id="kt_content_container" class="container-xxl pb-6">
            ...
            <div class="card">
                ...
                <div class="card-body py-4">
                    ...
                    <form id="kt_modal_add_user_form" class="form" action="{{ url('/management/roles/edit/confirm/'.$role->id) }}" method="post" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="fv-row mb-7 col-md-12 col-xs-12">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="name" value="{{ $role->name }}" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Moderator"/>
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <textarea type="text" name="description" class="form-control form-control-solid mb-3 mb-lg-0">{{ $role->description }}</textarea>
                            <!--end::Input-->
                        ...
                        <div class="" style="float:right;">
                            <a href="{{ url('/management/roles/') }}" class="btn btn-light me-3">{{ __('Discard') }}</a>
