...
<title>{{ __('Garage | Permissions List') }}</title>
...
@section('toolbar-content')
    ...
    @section('create-button')
        <a href="{{ url('/management/permissions/create') }}" class="btn btn-sm btn-primary">{{ __('Create') }}</a>
    @endsection
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <!--end::Svg Icon-->
                            <input type="text" id="searchinput" data-kt-user-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="{{ __('Search permissions') }}" />
                        </div>
                        <!--end::Search-->
                    </div>
                    <!--begin::Card title-->
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <!--end::Export-->
                            <!--begin::Add user-->
                            <a href="{{ url('/management/permissions/create') }}" class="btn btn-primary">
                            ...
                            <!--end::Svg Icon-->{{ __('Add Permission') }}</a>
                            <!--end::Add user-->
                        </div>
                        <!--end::Toolbar-->
                        <!--begin::Group actions-->
                            ...
                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header">
                                        <!--begin::Modal title-->
                                        <h2 class="fw-bolder">{{ __('Export Permissions') }}</h2>
                                        <!--end::Modal title-->
                                        <!--begin::Close-->
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_permissions">
                        ...
                        <tbody class="text-gray-600 fw-bold">
                            ...
                            <tr>
                                ...
                                @php $createdAt = Carbon\Carbon::parse($permission->created_at) @endphp
                                ...
                                {{-- <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        <!--begin::Menu item-->
                                        @canany(['permissions.management.edit', 'everything'])
                                            <div class="menu-item px-3">
                                                <a href="{{ url('/management/permissions/edit/'.$permission->id) }}" class="menu-link px-3">{{ __('Edit') }}</a>
                                            </div>
                                        @endcanany
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        @canany(['permissions.management.delete', 'everything'])
                                            <div class="menu-item px-3">
                                                <a href="{{ url('/management/permissions/pre-delete/'.$permission->id) }}" class="menu-link px-3" data-kt-users-table-filter="delete_row">{{ __('Delete') }}</a>
                                            </div>
                                        @endcanany
                                        <!--end::Menu item-->
                                    </div>
