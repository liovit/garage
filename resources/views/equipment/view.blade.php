...
<title>{{ __('Garage | Viewing Equipment') }} {{ $equipment->id }}</title>
...
@section('toolbar-content')
    ...
    @section('create-button')
        <a href="{{ url('/work/equipment/edit/'.$equipment->id) }}" class="btn btn-sm btn-primary">{{ __('Edit') }}</a>
    @endsection
            ...
            <div class="card card-flush col-md-12">
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="d-flex flex-column text-gray-600">
                        ...
                        <span class="bullet bg-primary me-3"></span>{{ __('ID') }}: <b class="px-2"><div class="badge badge-light fw-bolder" style="font-size: 0.95rem;">{{ $equipment->id }}</div></b></div>

                        @if($equipment->title)
                            <div class="d-flex align-items-center py-2">
                            <span class="bullet bg-primary me-3"></span>{{ __('Title') }}: <b class="px-2"><div class="badge badge-light fw-bolder" style="font-size: 0.95rem;">{{ $equipment->title }}</div></b></div>
                        @endif

                        @if($equipment->description)
                            <div class="d-flex align-items-center py-2">
                            <span class="bullet bg-primary me-3"></span>{{ __('Description') }}: <b class="px-2"><div class="badge badge-light fw-bolder" style="font-size: 0.95rem;">{{ $equipment->description }}</div></b></div>
                        @endif

                        @if($equipment->type)
                            <div class="d-flex align-items-center py-2">
                            <span class="bullet bg-primary me-3"></span>{{ __('Type') }}: <b class="px-2"><div class="badge badge-light fw-bolder" style="font-size: 0.95rem;">{{ $equipment->type }}</div></b></div>
                        @endif

                        @if($equipment->location)
                            <div class="d-flex align-items-center py-2">
                            <span class="bullet bg-primary me-3"></span>{{ __('Location') }}: <b class="px-2"><div class="badge badge-light fw-bolder" style="font-size: 0.95rem;">{{ $equipment->location }}</div></b></div>
                        @endif

                        @if($equipment->price)
                            <div class="d-flex align-items-center py-2">
                            <span class="bullet bg-primary me-3"></span>{{ __('Price') }}: <b class="px-2"><div class="badge badge-light fw-bolder" style="font-size: 0.95rem;">{{ __('$') }} {{ $equipment->price }}</div></b></div>
                        @endif

                        @if($equipment->quantity)
                            <div class="d-flex align-items-center py-2">
                            <span class="bullet bg-primary me-3"></span>{{ __('Quantity') }}: <b class="px-2"><div class="badge badge-light fw-bolder" style="font-size: 0.95rem;">{{ $equipment->quantity }}</div></b></div>
                        @endif

                        @if($equipment->creation_date)
                            <div class="d-flex align-items-center py-2">
                            <span class="bullet bg-primary me-3"></span>{{ __('Manufacturer Date') }}: <b class="px-2"><div class="badge badge-light fw-bolder" style="font-size: 0.95rem;">{{ $equipment->creation_date }}</div></b></div>
                        @endif

                        @if($equipment->warranty_time)
                            <div class="d-flex align-items-center py-2">
                            <span class="bullet bg-primary me-3"></span>{{ __('Warranty Expires') }}: <b class="px-2"><div class="badge badge-light fw-bolder" style="font-size: 0.95rem;">{{ $equipment->warranty_time }}</div></b></div>
                        @endif
...
<script>
    ...
    $(document).ready( function () {
        ...
        $('.menu-equipment-inventory-list').addClass('show');
