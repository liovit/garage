...
<title>{{ __('Garage | Equipment Inventory List') }}</title>
        ...
        <div id="kt_content_container" class="container-xxl pb-6">
            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <!--end::Export-->
                            <!--begin::Add Order-->
                            <a href="{{ url('/work/equipment/create') }}" class="btn btn-primary">
                ...
                <div class="card-body py-4">
                    <!--begin::Table-->
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_equipment_inventory">
                        <!--begin::Table head-->
                        <thead>
                            <!--begin::Table row-->
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex flex-column">
                                        <img src="{{ url('/temporary/equipment/'.$item->id.'/'.$item->picture) }}" class="thumbnail" style="width: 50px; height: 50px; border-radius: 3px;" alt="">
                                    </div>
                                </td>
                                @else
                                <td>
                                ...
                                <td>
                                    <div class="d-flex flex-column">
                                        <a href="{{ url('/work/equipment/'.$item->id) }}" class="text-gray-800 text-hover-primary mb-1">{{ $item->description }}</a>
                                    </div>
                                </td>
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        <!--begin::Menu item-->
                                        @canany(['equipment.view', 'everything'])
                                            <div class="menu-item px-3">
                                                <a href="{{ url('/work/equipment/'.$item->id) }}" class="menu-link px-3">{{ __('View') }}</a>
                                            </div>
                                        @endcanany
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        @canany(['equipment.edit', 'everything'])
                                            <div class="menu-item px-3">
                                                <a href="{{ url('/work/equipment/edit/'.$item->id) }}" class="menu-link px-3">{{ __('Edit') }}</a>
                                            </div>
                                        @endcanany
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        @canany(['equipment.delete', 'everything'])
                                            <div class="menu-item px-3">
                                                <a href="{{ url('/work/equipment/pre-delete/'.$item->id) }}" class="menu-link px-3" data-kt-users-table-filter="delete_row">{{ __('Delete') }}</a>
                                            </div>
                                        @endcanany
                                        <!--end::Menu item-->
                                    </div>
...
@endsection
    ...
    <script>
        ...
        $(document).ready( function () {
            ...
            var table = $('#kt_table_equipment_inventory').DataTable({
                info: !1,
                "order": [[ 1, "desc" ]],
                colReorder: true,
                stateSave: true,
