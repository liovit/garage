...
<title>{{ __('Garage | Equipment Orders List') }}</title>
...
@section('toolbar-content')
    ...
    @section('create-button')
        <a href="{{ url('/work/order/equipment') }}" class="btn btn-sm btn-primary">{{ __('Create') }}</a>
    @endsection
        ...
        <div id="kt_content_container" class="container-xxl pb-6">
            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <!--end::Export-->
                            <!--begin::Add Order-->
                            <a href="{{ url('/work/order/equipment') }}" class="btn btn-primary">
                ...
                <div class="card-body py-4">
                    <!--begin::Table-->
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_equipment_orders">
                        <!--begin::Table head-->
                        <thead>
                            <!--begin::Table row-->
                        ...
                        <tbody class="text-gray-600 fw-bold">
                            ...
                            @php $id_count = 1; @endphp

                            @foreach($equipment->unique('order_id') as $order)  
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="d-flex flex-column">
                                        <a href="{{ url('/work/order/equipment/'.$order->order_id) }}" class="text-gray-800 text-hover-primary mb-1">{{ $id_count++ }}</a>
                                    </div>
                                </td>
                                <!--end::ID-->
                                <!--begin::Description=-->
                                ...
                                <td>
                                    <div class="d-flex flex-column">
                                        <a href="{{ url('/work/order/equipment/'.$order->order_id) }}" class="text-gray-800 text-hover-primary mb-1">{{ $order->description }}</a>
                                    </div>
                                </td>
                                ...
                                @php 
                                    ...
                                    $equipment_order = App\Models\Equipment_Order::where('order_id', '=', $order->order_id)->get(); 

                                    foreach($equipment_order as $item) {
                                ...
                                <td>
                                    <div class="d-flex flex-column">
                                        <a href="{{ url('/management/suppliers/'.$supplier->id) }}" class="text-gray-800 text-hover-primary mb-1">{{ $supplier->supplier_company }}</a>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div class="d-flex flex-column">
                                        <div class="badge badge-light fw-bolder">{{ $createdAt->format('Y-m-d') }}</div>
                                    </div>
                                </td>
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        <!--begin::Menu item-->
                                        @canany(['equipment.orders.view', 'everything'])
                                            <div class="menu-item px-3">
                                                <a href="{{ url('/work/order/equipment/'.$order->order_id) }}" class="menu-link px-3">{{ __('View') }}</a>
                                            </div>
                                        @endcanany
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        @canany(['equipment.orders.edit', 'everything'])
                                            <div class="menu-item px-3">
                                                <a href="{{ url('/work/order/equipment/edit/'.$order->order_id) }}" class="menu-link px-3">{{ __('Edit') }}</a>
                                            </div>
                                        @endcanany
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        @canany(['equipment.orders.delete', 'everything'])
                                            <div class="menu-item px-3">
                                                <a href="{{ url('/work/order/equipment/pre-delete/'.$order->order_id) }}" class="menu-link px-3" data-kt-users-table-filter="delete_row">{{ __('Delete') }}</a>
                                            </div>
                                        @endcanany
                                        <!--end::Menu item-->
                                    </div>
...
@endsection
    ...
    <script>
        ...
        $(document).ready( function () {
            ...
            var table = $('#kt_table_equipment_orders').DataTable({
                info: !1,
                "order": [[ 1, "desc" ]],
                colReorder: true,
                stateSave: true,
